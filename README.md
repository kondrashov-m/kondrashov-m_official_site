# kondrashov-m | Официальный репозиторий проекта
...
### Этот репозиторий содержит открытый исходный код моего персонального портфолио, где вы найдете проекты, резюме и контактную информацию.
